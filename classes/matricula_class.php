...
class Matricula {
    ...
    public function Inserir(){
        $sql = "INSERT INTO matricula (nome_matricula, cpf_docente, email_docente, rua_docente, bairro_docente, cidade_docente, estado_docente, pais_docente, cep_docente) VALUE(?,?,?,?,?,?,?,?,?)";
        ...
        $comando->execute(array($this->nome, $this->data, $this->status));
