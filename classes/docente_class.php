...
class Docente{
    ...
    public function Inserir(){
        $sql = "INSERT INTO docente (nome_docente, cpf_docente, email_docente, rua_docente, bairro_docente, cidade_docente, estado_docente, pais_docente, cep_docente) VALUE(?,?,?,?,?,?,?,?,?)";
